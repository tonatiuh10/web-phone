<div class=" mb-3 me-1" style="max-width: 100%;">
    <div class="row no-gutters">
      ...
      <div class="card-body col-md-9">
        ...
        <p class="card-text"><small class="text-muted">{{$rol}}</small></p>
      </div>
        ...
        <div class="card-group">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text"><small class="text-body-secondary">3 mins</small></p>
            </div>
          </div>
          <div class="card">
            <div class="card-body">
              <medium class="card-title">Servicios</medium>
              <p class="card-text"><small class="text-body-secondary">Last</small></p>
            </div>
          </div>
          <div class="card">
            <div class="card-body">
              <medium class="card-title">Ingresos</medium>
              <p class="card-text"><small class="text-body-secondary"> ago</small></p>
            </div>
          </div>
        </div>
      </div>
