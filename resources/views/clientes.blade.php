...
@section('content')
    ...
    <div class="d-flex mt-2 h-25">
        <div class="w-50 card mb-3 ms-1">
            <p class="text-secondary m-1 p-2">Top Clientes</p>
        ...
        <div class="w-50 card mb-3 ms-1">
            <p class="text-secondary m-1 p-2">Clientes Recientes</p>
            <table class="table table-sm">
                <thead>
                  <tr>
                    <th scope="col">ID</th>
